...
public class fragmentFiles3 extends Fragment {
    ...
    public fragmentFiles3() {

    }

    public static fragmentFiles3 newInstance(String param1, String param2) {
        fragmentFiles3 fragment = new fragmentFiles3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =  inflater.inflate(R.layout.fragment_files3, container, false);

        recview1 = (RecyclerView) view.findViewById(R.id.recview_file3);
        ...
        FirebaseRecyclerOptions<FileInfoModel> options =
                new FirebaseRecyclerOptions.Builder<FileInfoModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference(auth).child("My_Documents").child("apartment3").orderByChild("id").equalTo("apartment3"), FileInfoModel.class).build();
