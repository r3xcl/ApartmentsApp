...
public class Fragment_Repair2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_repair2, container, false);
        ...
        FirebaseRecyclerOptions<RepairClass> options1 =
                new FirebaseRecyclerOptions.Builder<RepairClass>()
                        .setQuery(FirebaseDatabase.getInstance().getReference(auth).child("Repairs_History").child("apartment2").orderByChild("id").equalTo("apartment2"), RepairClass.class).build();
