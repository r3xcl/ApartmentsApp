...
public class Fragment_Remont3 extends Fragment {
    ...
    public Fragment_Remont3() {

    }



    public static Fragment_Remont3 newInstance(String param1, String param2) {
        Fragment_Remont3 fragment = new Fragment_Remont3();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment__remont3, container, false);
        ...
        FirebaseRecyclerOptions<RemontClass> options1 =
                new FirebaseRecyclerOptions.Builder<RemontClass>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Repairs_History").orderByChild("id").equalTo("apartment3"),RemontClass.class).build();
